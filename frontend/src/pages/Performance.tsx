        ...
        <div className="flex flex-col gap-24 mt-24">
          ...
          <div id="sicherheit" className="flex flex-col md:flex-row gap-12 items-center scroll-mt-[100px]">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative group overflow-hidden rounded-sm shadow-xl">
                ...
                <img src="/images/performance/sicherheitstraining.webp" alt="Sicherheitstraining Gardasee" className="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-105" />
              </div>
            </div>
          </div>
          ...
          <div id="rettung" className="flex flex-col md:flex-row-reverse gap-12 items-center scroll-mt-[100px]">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative group overflow-hidden rounded-sm shadow-xl">
                <div className="absolute inset-4 border border-white/40 pointer-events-none z-10 transition-colors group-hover:border-luxury-gold/50"></div>
                <img src="/images/performance/rettungsgeraetetraining.webp" alt="Rettungsgerätetraining" className="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-105" />
              </div>
            </div>
          </div>
          ...
          <div id="refresher" className="flex flex-col md:flex-row gap-12 items-center scroll-mt-[100px]">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative group overflow-hidden rounded-sm shadow-xl">
                <div className="absolute inset-4 border border-white/40 pointer-events-none z-10 transition-colors group-hover:border-luxury-gold/50"></div>
                <img src="/images/performance/refresher.webp" alt="Refresherkurs" className="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-105" />
              </div>
            </div>
          </div>
          ...
          <div id="groundhandling" className="flex flex-col md:flex-row-reverse gap-12 items-center scroll-mt-[100px]">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative group overflow-hidden rounded-sm shadow-xl">
                <div className="absolute inset-4 border border-white/40 pointer-events-none z-10 transition-colors group-hover:border-luxury-gold/50"></div>
                <img src="/images/performance/groundhandling.webp" alt="Groundhandling Kurs" className="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-105" />
              </div>
            </div>
          </div>
