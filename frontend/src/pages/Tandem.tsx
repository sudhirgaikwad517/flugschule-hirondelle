      ...
      <div className="container mx-auto px-4 py-8 max-w-[1200px]">
        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-16">
          ...
          <div className="w-full lg:w-3/5">
            {/* Video Placeholder */}
            <div className="relative w-full aspect-video bg-gray-200 mb-12 group overflow-hidden cursor-pointer rounded-sm shadow-xl">
          ...
          <div className="w-full lg:w-2/5">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="overflow-hidden rounded-sm relative group"><div className="absolute inset-2 border border-white/40 pointer-events-none z-10 transition-colors group-hover:border-luxury-gold/50"></div><img src="https://picsum.photos/id/1035/300/300" alt="Impression 1" className="w-full h-auto transition-transform duration-1000 group-hover:scale-105" /></div>
                <div className="overflow-hidden rounded-sm mt-8 relative group"><div className="absolute inset-2 border border-white/40 pointer-events-none z-10 transition-colors group-hover:border-luxury-gold/50"></div><img src="https://picsum.photos/id/1036/300/300" alt="Impression 2" className="w-full h-auto transition-transform duration-1000 group-hover:scale-105" /></div>
                <div className="overflow-hidden rounded-sm -mt-8 relative group"><div className="absolute inset-2 border border-white/40 pointer-events-none z-10 transition-colors group-hover:border-luxury-gold/50"></div><img src="https://picsum.photos/id/1043/300/300" alt="Impression 3" className="w-full h-auto transition-transform duration-1000 group-hover:scale-105" /></div>
                <div className="overflow-hidden rounded-sm relative group"><div className="absolute inset-2 border border-white/40 pointer-events-none z-10 transition-colors group-hover:border-luxury-gold/50"></div><img src="https://picsum.photos/id/1044/300/300" alt="Impression 4" className="w-full h-auto transition-transform duration-1000 group-hover:scale-105" /></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20">
          ...
          <button className="px-8 py-3 bg-transparent border border-luxury-gold text-luxury-gold hover:bg-luxury-gold hover:text-white transition-colors duration-300 uppercase tracking-widest text-[10px] font-semibold rounded-sm w-full md:w-auto mb-20 text-center">
            ZUM TANDEM-NEWSLETTER ANMELDEN
          </button>
        </div>
        ...
        <div className="flex flex-wrap gap-12 md:gap-16 mb-20">
          {[
            { name: 'Alex', img: 'https://picsum.photos/id/1025/300/300' },
            { name: 'Markus', img: 'https://picsum.photos/id/1027/300/300' },
            { name: 'Karl-Peter', img: 'https://picsum.photos/id/1032/300/300' },
            { name: 'Tobi', img: 'https://picsum.photos/id/1033/300/300' }
          ].map((pilot) => (
