      ...
      <div className="container mx-auto px-4 py-12 max-w-[1200px]">
        ...
        <div className="mb-24 flex flex-col items-center text-center">
          ...
          <p className="text-gray-500 leading-relaxed font-light mb-10 max-w-4xl">
            Unsere <Link to="/reisen" className="text-[#428bca] hover:text-[#2a6496] hover:underline font-bold">Reisen</Link> führen uns in die bekannten Fluggebiet-Hotspots. So zählt <Link to="/reisen/bassano-tour" className="text-[#428bca] hover:text-[#2a6496] hover:underline font-bold">Bassano</Link> – das Mekka der Gleitschirmszene – jährlich fest zum Programm. Aber auch entlegene Ziele wollen wir euch nicht vorenthalten und bieten euch Reisen nach <Link to="/reisen/suedafrika-tour" className="text-[#428bca] hover:text-[#2a6496] hover:underline font-bold">Südafrika</Link> und weiteren besonderen Zielen weltweit an. Im Rahmen unserer <Link to="/reisen" className="text-[#428bca] hover:text-[#2a6496] hover:underline font-bold">Reisen</Link> könnt ihr unter Fluglehrerbetreuung sehr viel Erfahrung sammeln, eure Flugtechnik verbessern und zahlreiche großartige Flugstunden genießen.
          </p>
