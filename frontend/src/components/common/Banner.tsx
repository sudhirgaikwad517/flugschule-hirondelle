...
const HOME_SLIDES: BannerSlide[] = [
  { image: '/images/headers/slider4.webp', text: 'Erlebe die Freiheit des Fliegens' },
  { image: '/images/headers/slider_gardasee.webp', text: 'Sicherheitstraining am Gardasee' },
  { image: '/images/headers/slider_griechenland2.webp', text: 'Türkisblaues Meer' },
  { image: '/images/headers/slider1.webp' },
  { image: '/images/headers/sliderbschein.webp', text: 'Genuss unter den Wolken' },
  { image: '/images/headers/slider11.webp', text: "Fliegen im Sommer an der Düne..." },
  { image: '/images/headers/P1030577.webp', text: '... und im Winter im Schnee' },
  { image: '/images/headers/slider_groundhandling.webp', text: 'Groundhandling auf der Wiese' },
  { image: '/images/headers/P1030623.webp', text: 'Traumhafte Ausblicke von ganz oben' },
  { image: '/images/headers/slider_bergamo.webp' },
  { image: '/images/headers/slider_kolumbien1.webp', text: 'Über den Zuckerrohrfeldern in Kolumbien' },
  { image: '/images/headers/DSC00324.webp' },
  { image: '/images/headers/slider_pfalz.webp', text: 'Burgumrundung im Pfälzerwald' },
  { image: '/images/headers/slider2.webp', text: 'Ausbildung auf höchstem Niveau', linkUrl: '/' },
  { image: '/images/headers/DSC05188.webp' },
  { image: '/images/headers/slider_allgu.webp', text: 'Allgäuer Höhenluft' },
  { image: '/images/headers/slider_brasilien.webp', text: 'Unter der Sonne Brasiliens' },
  { image: '/images/headers/slider_bassano.webp', text: 'Bassano - das Mekka der Gleitschirmszene' },
  { image: '/images/headers/slider3.webp', text: "Doppelt fliegt's besser: Tandemflüge" },
  { image: '/images/headers/slider_griechenland1.webp', text: 'Griechenland - einmal die Küste abfliegen' },
  { image: '/images/headers/slider_griechenland3.webp', text: 'Sightseeing von oben' },
  { image: '/images/headers/slider_griechenland4.webp' },
  { image: '/images/headers/slider_griechenland5.webp', text: 'Gechillt beim Landecocktail' },
  { image: '/images/headers/slider_kolumbien3.webp', text: 'Packservice am Landeplatz' },
  { image: '/images/headers/slider_kolumbien4.webp' },
  { image: '/images/headers/slider_kolumbien5.webp' },
  { image: '/images/headers/slider_sa6.webp', text: 'Im Sandkasten Südafrikas' },
  { image: '/images/headers/slider_pfalz2.webp' },
  { image: '/images/headers/slider_sa4.webp' },
  { image: '/images/headers/slider_pfalz3.webp', text: 'Vom Pfälzer Rebenmeer in die Rheinebene' },
  { image: '/images/headers/slider_sa1.webp' },
  { image: '/images/headers/slider_sa2.webp', text: 'Paradiesisch an der Paradise Ridge in Südafrika' },
  { image: '/images/headers/slider_sa3.webp' },
  { image: '/images/headers/slider_spanien.webp' },
  { image: '/images/headers/slider_slowenien.webp' },
  { image: '/images/headers/slider_sa5.webp' },
  { image: '/images/headers/slider_stubai.webp', text: 'Das Stubaital' },
];
...
const SUBPAGE_SLIDES: BannerSlide[] = [
  { image: '/images/headers/slider11.webp' },
  { image: '/images/headers/P1030623.webp' },
  { image: '/images/headers/slider_sa4.webp' },
  { image: '/images/headers/slider_griechenland4.webp' },
  { image: '/images/headers/slider_griechenland1.webp' },
  { image: '/images/headers/slider4.webp' },
  { image: '/images/headers/slider_bergamo.webp' },
  { image: '/images/headers/slider_pfalz3.webp' },
  { image: '/images/headers/slider_sa2.webp' },
  { image: '/images/headers/slider_spanien.webp' },
  { image: '/images/headers/slider_kolumbien1.webp' },
  { image: '/images/headers/slider_sa5.webp' },
  { image: '/images/headers/slider_bassano.webp' },
  { image: '/images/headers/slider_pfalz2.webp' },
  { image: '/images/headers/slider_allgu.webp' },
  { image: '/images/headers/slider_stubai.webp' },
  { image: '/images/headers/slider3.webp' },
  { image: '/images/headers/slider_sa6.webp' },
  { image: '/images/headers/slider_groundhandling.webp' },
  { image: '/images/headers/slider2.webp' },
  { image: '/images/headers/slider_slowenien.webp' },
  { image: '/images/headers/slider_griechenland3.webp' },
  { image: '/images/headers/slider_kolumbien3.webp' },
  { image: '/images/headers/slider_griechenland5.webp' },
  { image: '/images/headers/slider_pfalz.webp' },
  { image: '/images/headers/slider_kolumbien4.webp' },
  { image: '/images/headers/slider1.webp' },
  { image: '/images/headers/slider_brasilien.webp' },
  { image: '/images/headers/slider_gardasee.webp' },
  { image: '/images/headers/P1030577.webp' },
  { image: '/images/headers/slider_teneriffa.webp' },
  { image: '/images/headers/slider_sa1.webp' },
  { image: '/images/headers/slider_kolumbien5.webp' },
  { image: '/images/headers/slider_griechenland2.webp' },
];
